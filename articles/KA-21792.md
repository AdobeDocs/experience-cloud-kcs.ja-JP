...
<b>問題/症状</b>
<br>リリース2023.02.11382では、古いリリースの誤った動作に依存している場合にアプリケーションコードで予期しない動作が発生する可能性がある、GraphQL（オープンソースクエリ言語）の実装が改善されました。 
<br>以下に示す解決方法を使用すると、Adobe Experience Manager(AEM)GraphQLは、すべてのフィルター操作で一貫した null 値のコンテンツを返すようになります。 <br><br>
