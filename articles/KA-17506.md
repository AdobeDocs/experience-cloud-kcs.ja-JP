...
- 以下を使用： <b>TCP ストリームに従う</b> ツールを使用して、作業中のストリームを分離します。<br><br>ポップアップする赤／青のテキストウィンドウは、SMPP とは関係のないテキストプロトコルににのみ有用なので、閉じてください。
...
<b>MT のエンコード</b>
注意：SMS エンコーディングは、多くのトラップと様々な実装を備えた複雑な主体です。
