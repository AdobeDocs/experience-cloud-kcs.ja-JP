...
<b>問題</b>
リダイレクトは、Web ブラウザーがユーザー操作なしで新しい場所を指すようにします。 問い合わせ [リダイレクトとエイリアス](https://experienceleague.adobe.com/docs/analytics/technotes/redirects.html) ( Adobe Analytics実装ドキュメント ) を参照してください。
