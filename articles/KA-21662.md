---
title: "mod_security:サイズの大きいファイル/アセットをアップロードできません"
description: 説明
...
mod_security のバージョン 9 を使用しているお客様は、大きなファイルやアセットをアップロードできません。 これらは、オーサーに直接アクセス（Dispatcher をバイパス）することでアップロードする必要があります。

error.log には次の情報が表示されます。
