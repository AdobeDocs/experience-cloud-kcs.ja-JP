...
keywords: 'KCS,mod_security, バージョン 9，大きなファイル/アセットをアップロードできません，'
...
最新バージョンの mod_security にアップデートして、大きなファイル/アセットをアップロードする方法を説明します。
...
mod_security のバージョン 9 では、大きなファイル/アセットをアップロードできません。 オーサーに直接移動して（Dispatcher をバイパスして）アップロードする必要があります。
