...
<b><u>AEM Sitesのパフォーマンスに関する問題</u></b>
 <br>
<b>パフォーマンスの問題の症状</b>
...
4. システムのメンテナンス手順を確認します。 参照 [記事](https://experienceleague.adobe.com/docs/experience-manager-65/deploying/configuring/monitoring-and-maintaining.html) AEMのメンテナンスの詳細。また、AEMで適切なメンテナンスをおこなうには、以下をおこないます。
...
- アセット処理のパフォーマンスの調整 ( [この記事](https://experienceleague.adobe.com/docs/experience-manager-65/assets/administer/performance-tuning-guidelines.html?lang=ja).
