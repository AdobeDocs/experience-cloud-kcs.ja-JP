...
ヒープダンプファイルを取り込んだら、次の場所で開きます。 [Eclipse マット](https://www.eclipse.org/mat/) または [IBM Memory Analyzer](https://developer.ibm.com/languages/java/) ツール  Eclipse MAT で、Leak Suptes レポートを実行し、「Thread Details」ビューを開いて、メモリ問題の潜在的な原因を確認します。
