...
4. システムのメンテナンス手順を確認します。 参照 [記事](https://experienceleague.adobe.com/docs/experience-manager-65/deploying/configuring/monitoring-and-maintaining.html)r を参照してください。また、AEMで適切なメンテナンスをおこなうには、次の点を確認してください。
...
<br> <b>Assets のパフォーマンスに関する問題</b><br> 
