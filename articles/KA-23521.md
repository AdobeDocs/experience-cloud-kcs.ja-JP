---
title: ページ移動機能が機能しない
description: コンテンツフラグメント参照の取得に関する問題が原因で削除または公開に失敗する、移動ページ機能の問題を解決する方法について説明します。
solution: Experience Manager
product: Experience Manager
applies-to: Experience Manager 6.5
keywords: KCS、ページ移動機能、削除、参照取得の問題、AMS のお客様、CSE 支援、インデックス再作成、コンテンツフラグメント、パブリッシュ
...
コンテンツフラグメント参照の取得の問題による削除や公開などのアクションを妨げる、移動ページ機能の不具合に対処する方法を説明します。
...
コンテンツフラグメント、サイト、ページのいずれかを移動、削除または公開しようとすると、コンテンツフラグメントの参照が取得されたときに問題が発生し、アクションが実行されませんでした。
