---
title: に HTML をインポート中にエラーが発生しました [!UICONTROL E メールデザイナー]
description: 説明
solution: Campaign
product: Campaign
...
# に HTML をインポート中にエラーが発生しました [!UICONTROL E メールデザイナー]

## 説明

<b>問題：</b><br><br> <br><br>.zip ファイルのインポート中に、HTMLファイルと画像が含まれて [!UICONTROL E メールデザイナー] 以下のエラーが発生しました：<br><br> <br><br>
