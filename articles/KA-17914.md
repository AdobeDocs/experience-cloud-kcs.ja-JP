...
この問題を修正するには、AEMインスタンスにバニティー URL 機能パックをインストールし、匿名ユーザーがその機能パックを準備できるようにしてください。 詳細は[こちら](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17463.html%3Flang%3Dja)
