---
title: 「JWT の期限が切れました」エラーでBrand Portalに接続できません | AEM
description: 説明
solution: Experience Manager
product: Experience Manager
applies-to: Experience Manager
keywords: KCS，接続， Brand Portal，レプリケーションエージェント， JWT の期限が切れました， AEM, Adobe Experience Manager, 6.2，エラー
...
# 「JWT の期限が切れました」エラーでBrand Portalに接続できません | AEM

## 説明


<b>問題 </b>
AEM AssetsとBrand Portalの統合の設定後 [https://experienceleague.adobe.com/docs/experience-manager-65/assets/brandportal/configure-aem-assets-with-brand-portal.html?lang=en](https://experienceleague.adobe.com/docs/experience-manager-65/assets/brandportal/configure-aem-assets-with-brand-portal.html?lang=ja),

<b>接続をテスト</b> レプリケーションエージェントでは、次のようなエラーメッセージが返されます。
...
<b>環境</b>
AEM 6.2 とBrand Portal

<b>原因</b>
原因は、AEMインスタンスとBrand Portalクラウドの時間差です。
この差により、JWT の有効期限が切れます。
