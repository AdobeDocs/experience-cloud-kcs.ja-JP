...
ページを開くと、ユーザーは「<b>無効なリクエスト</b>&quot;件の応答（メッセージを含む）
...
このエラーは、 #LimitRequestFieldSizeと#LimitRequestLineの値を増やすことで解決できます

AMS/オンプレミス：

Apache 設定ファイル ( httpd.conf) でヘッダーの制限を増やすことができます



AEMaaCS:

Vhost ファイルに上記のプロパティを追加して、リクエストヘッダーの制限を増やします。
