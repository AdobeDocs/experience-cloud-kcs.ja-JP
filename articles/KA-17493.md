...
<br><br><br><br>仕組み<br><br><br><br><br><br>操作の順序<br><br><br><br><br><br>
...
<br><br><br><br><br><br>作成者レプリケーションエージェント<br><br><br><br><br><br>
...
<br><br><br><br><br><br>パブリッシャーレプリケーションエージェント<br><br><br><br><br><br>
設定済みの標準フラッシュレプリケーションエージェントのスクリーンショットの例を次に示します
![AEM web ページ/etc/replication.htmlからの標準フラッシュレプリケーションエージェントのスクリーンショット](https://helpx.adobe.com/content/dam/kb/en/ams-dispatcher-manual/publish-flush-rep-agent-example.png "publish-flush-rep-agent-example")<br><br><br><br><br><br>仮想ホストを受け取る DISPATCHER フラッシュレプリケーション<br><br><br><br><br><br>
...
デフォルト設定ページには、 <b>[!UICONTROL シリアル化の種類]</b> as *[!UICONTROL Dispatcher フラッシュ]* エラーレベルを設定します。
...
の [!UICONTROL 輸送] タブをクリックすると、 [!UICONTROL URI] フラッシュ要求を受け取る dispatcher の IP アドレスを指すように設定されている。  パス `/dispatcher/invalidate.cache` モジュールが、フラッシュであるかどうかを、アクセスログに表示され、フラッシュリクエストであることを知るための明白なエンドポイントであるかどうかを判断する方法ではありません。  の [!UICONTROL 拡張] 「 」タブでは、dispatcher モジュールに対するフラッシュリクエストであると見なすために存在する事項を確認します。
...
この [!UICONTROL HTTP メソッド] フラッシュリクエストの場合、次に示す特別なリクエストヘッダーを持つGETリクエストに過ぎません。
...
- ホスト
   - ここで、 `Host` 特定の `VirtualHost` Dispatcher に設定されている [!DNL Apache] web サーバー (`/etc/httpd/conf.d/enabled_vhosts/aem_flush.vhost`) をクリックします。  これは、 `aem_flush.vhost` ファイルの *`ServerName`* または *`ServerAlias`*
...
の [!UICONTROL トリガー] タブで、使用する切り替え済みトリガーと、その内容をメモします
...
<br><br><br><br><br><br>この `.stat` ファイル<br><br><br><br><br><br>
...
![コンテンツと日付が混在した statfiles と、stat レベルで表示された stat ファイル](https://helpx.adobe.com/content/dam/help/en/experience-manager/kb/ams-dispatcher-manual/disp-flushing/jcr_content/main-pars/image_2035486865/dispatcher-statfiles.png "dispatcher-statfiles")<br><br><br><br><br><br>STAT ファイルのレベル<br><br><br><br>
各ディレクトリには、 `.stat` ファイルが存在する。  これは、フラッシュが発生したことを示すインジケータです。  上記の例では、 <b>`statfilelevel`</b> 設定が次のように設定されています： <b>`3`</b> 対応するファーム設定ファイル内にあります。
...
<br><br><br><br> <br><br>STAT ファイルのタイムスタンプハンドシェイク<br><br><br><br><br><br>
...
<br><br><br><br><br><br>キャッシュハンドシェイク — 例 1<br><br><br><br><br><br>
...
<br><br><br><br><br><br>キャッシュハンドシェイク — 例 2<br><br><br><br><br><br>
...
<br><br><br><br><br><br>ファームファイル設定<br><br><br><br><br><br>
...
このディレクトリは [!DNL Apache] web サーバーが使用するように設定されているドメインのドキュメントルート設定です。

のサブフォルダーに存在する各ファームごとに、ネストされた docroot フォルダーを持つ [!DNL Apache] ドキュメントルートは、多くの理由でひどいアイデアです。


<br><br><br><br><br><br>Stat Files Level<br><br><br><br><br><br>
この設定エントリは、ファームファイルの次のセクションにあります。
<br><br><br><br><br> <br><br><br><br>
...
<br><br><br><br><br><br>無効化を許可<br><br><br><br><br><br>
この設定エントリは、ファームファイルの次のセクションにあります。
<br><br><br><br><br> <br><br><br><br>
...
<br><br><br><br><br><br><br>無効化ルール<br><br><br><br><br><br>
この設定エントリは、ファームファイルの次のセクションにあります。
<br><br><br><br><br> <br><br><br><br>
...
<br><br>テスト/トラブルシューティング<br><br><br><br><br><br>
