...
宛先[Maven プロジェクトを作成する](https://experienceleague.adobe.com/docs/experience-manager-cloud-manager/content/getting-started/project-creation/build-environment.html?lang=en#installing-additional-system-packages)exec プラグインを使用して Python3 をインストールするには、pom.xml の設定を行う必要があります。
