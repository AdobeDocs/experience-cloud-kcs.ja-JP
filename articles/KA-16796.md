...
1. 開く <b>CRX/DE</b> 管理者ユーザーとして。

2. ノードの削除 `/etc/truststore/truststore.p12`.

3. クリック <b>[!UICONTROL すべて保存]</b>.

4. 以下の手順に従って、トラストストアを再作成します。
