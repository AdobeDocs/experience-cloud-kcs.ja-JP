...
[&lt; — 前：基本ファイルレイアウト](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17502.html?lang=ja)
...
![この図は、1 つの.vhost ファイルが、変数、ホワイトリスト、および書き換えフォルダーのファイルをどのように含むかを示しています](assets/Apache-Webserver-AMS-Vhost-Includes.png "Apache-Webserver-AMS-Vhost-Includes")
...
![<FILENAME>_farms.any は、ファームの構成を完了するためにサブ.any ファイルを含めます。  この図では、ファームに各トップレベルセクションファイルのキャッシュ、クライアントヘッダー、フィルター、レンダリング、および vhosts .any ファイルが含まれていることがわかります。](assets/Apache-Webserver-AMS-Farm-Includes.png "Apache-Webserver-AMS-Farm-Includes")
...
[次へ —> キャッシュについて](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17912.html?lang=ja)