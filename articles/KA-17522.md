...
Target のような DMA ソリューションの API 呼び出しを実行するAdobeIO ベアラートークンを生成するための明確で再現可能な手順を提供する。
...
- <b>次のドキュメントに従って、秘密鍵と公開証明書を生成します。</b> https://www.adobe.io/apis/cloudplatform/console/authentication/createcert.html
   ...
   インストール段階で、追加のパッケージを検索してインストールできます。 「curl」と「ssh」に関連するすべてのものをインストールすることをお勧めします。*
...
![rtaImage](https://helpx.adobe.com/content/dam/help/en/marketing-cloud-core/kb/adobe-io-authentication-step-by-step/jcr%3acontent/main-pars/procedure/proc_par/step_0/step_par/image/rtaImage.png "rtaImage")<br> 
    ...
    ファイルを作成した後、次のコマンドを使用して secret.key を secret.pem に変換します。
...
- <b>Bearer アクセストークン用の Exchange JWT:</b>
   ...
   *注意：これをMac端末で実行すると、応答が切り捨てられたようです。 代わりに、Postmanを使用します。*
...
<br> <br> <br>
    ...
    | &#39;&quot;access_token&quot;: &quot;&quot;eyJ4NXUiJpbXNfbmExLWtleS0xLmNlciIsImFsZyI6IlJTMjU2In0..fVJVREKZH3PM71-Y05Kqxq_O_z7BL5NL6S4ypNoSwLuqR9WOiXsF0FGYcWZr6oO-jgYj8WrRePQLkg4GSoVthSbbXU6aqajPV2TsFNHpXRuJFBhql0e2eVQL_pVI9O_uCa8RloGjJuFyyEAvroQFEIJzC7Q-OAnkXMT7xD-3r1cEV2xP_N3s86t34M5Ud4Ofjas3RCJtAS1BEZOotlF_rB0kfvCZR9Krf-SVi_VedpsK7ipoJGfs7CLdN-_a4YGTC2CBJXwdK-4TQJRkWedr8oS0tzfVcQ4WEZfw1edi-OYSuIbXf-Obl5R9NCzi5RMceiGTyGMyRecmy3WQ&quot;`` |
    | — |
