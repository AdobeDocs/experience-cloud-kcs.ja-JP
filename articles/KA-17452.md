...
- jstack コマンド (<b>jstack -l pid threaddumps.log</b>) は以下のエラー 1 をスローし、java プロセスを所有するユーザーとしてコマンドを実行します。  例：
...
<br>UNIX、Mac OS X および Linux（JDK 1.4 以前のバージョン）<br>
