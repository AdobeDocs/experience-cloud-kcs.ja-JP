...
<u><b>質問：</b></u><br><br> <br><br>多数のアセットを選択して一括タグ付けする場合と同様に、多数のアセットを選択してAdobe Experience Managerでスマートタグを削除できますか？
...
フォルダー — タグを管理を選択し、ここで、フォルダー内のアセットを 1 つずつ移動して、タグを追加または削除できます。
