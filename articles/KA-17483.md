...
[&lt; — 前：共通ログ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17914.html?lang=ja)
...
![ボールがレーンを下りていくボーリングレーンを表示します。  ボールには、「 」という単語が付いた矢印が表示されます。  樋のバンパーは上に上がり、その上に不変ファイルという単語があります。](assets/bowling-file-immutability.png "ボウリングファイル不変性")
